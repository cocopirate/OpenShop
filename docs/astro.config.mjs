      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: '认证服务 PRD', slug: '05-services/auth-service/prd' },
            ...
            { label: '管理员服务 PRD', slug: '05-services/admin-service/prd' },
            ...
            { label: '消费者服务 PRD', slug: '05-services/consumer-service/prd' },
            { label: '商家服务', slug: '05-services/merchant-service/overview' },
            { label: '商家服务 PRD', slug: '05-services/merchant-service/prd' },
            { label: '订单服务', slug: '05-services/order-service/overview' },
            { label: '订单服务 PRD', slug: '05-services/order-service/prd' },
            { label: '短信服务', slug: '05-services/sms-service/overview' },
            { label: '短信服务 PRD', slug: '05-services/sms-service/prd' },
            { label: '第三方服务集成', slug: '05-services/third-party-service/overview' },
            { label: '第三方服务 PRD', slug: '05-services/third-party-service/prd' },
          ],
        },
        {
          label: '开发指南',
