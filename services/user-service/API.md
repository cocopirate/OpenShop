...
| 状态码 | 错误码 | 说明 |
|--------|--------|------|
| 401 | 40007 | 未携带 Token 或 Token 无效/过期 |
...
| 状态码 | 错误码 | 说明 |
|--------|--------|------|
| 400 | 40011 | 请求参数校验失败（Pydantic 验证错误） |
| 401 | 40007 | 未携带 Token、Token 无效/过期，或 Token 已被撤销 |
| 401 | 40004 | 账号已禁用 |
| 403 | 40010 | 账号已禁用（登录时）或缺少所需权限 |
| 404 | 40001 | 资源不存在 |
| 422 | 40011 | 请求体格式错误（FastAPI Unprocessable Entity） |
| 500 | 50000 | 服务器内部错误 |
